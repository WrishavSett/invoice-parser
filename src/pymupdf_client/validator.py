...
class ValidationConstants:
    ...
    NOTE_TEXT = """1. Please check the calculation/attendance/amount of the bill and inform us within 48 hours in case of any discrepancy, to avoid last minute rush. Any changes reported after 48 hours will be adjusted along with the next monthʼs bill.
